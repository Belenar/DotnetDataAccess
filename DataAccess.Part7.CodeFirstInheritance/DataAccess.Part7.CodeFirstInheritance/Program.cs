...
namespace DataAccess.Part7.CodeFirstInheritance
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                db.Vehicles.Add(new Car { Id = 1, Description = "BMW M4", HorsePower = 431, Seats = 4});
                db.Vehicles.Add(new Boat { Id = 2, Description = "Sun Odyssey 29.2", HullLength = 8.8M, MastHeight = 13.2M });
                db.SaveChanges();
